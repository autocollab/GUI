    ...
    var u = function (d, k) {
        ...
        return {
            ...
            onLoad: function () {
                ...
                // }
                current_edior_id = d.name;
                console.log('plugin image --> d.name: ' + d.name);
            },
            onHide: function () {
                this.preview && this.commitContent(8, this.preview);
                this.originalElement &&
                    (this.originalElement.removeListener("load", t), this.originalElement.removeListener("error", f), this.originalElement.removeListener("abort", f), this.originalElement.remove(), (this.originalElement = !1));
