    ...
    var r = function (c, j) {
        ...
        return {
            ...
            onShow: function () {
                ...
                this.imageEditMode
                    ? ((this.cleanImageElement = this.imageElement), (this.imageElement = this.cleanImageElement.clone(!0, !0)), this.setupContent(f, this.imageElement))
                                                    ...
                                                    children: [
                                                        {
                                                            ...
                                                            commit: function (a, b, d) {
                                                                var e = this.getValue();
                                                                a == f
                                                                    ? (e && c.activeFilter.check("img{width,height}") ? b.setStyle("width", CKEDITOR.tools.cssLength(e)) : b.removeStyle("width"), !d && b.removeAttribute("width"))
                                                                    : 4 == a
                                                                    ? e.match(k)
                                                        ...
                                                        },
                                                        {
                                                            ...
                                                            commit: function (a, b, d) {
                                                                var e = this.getValue();
                                                                a == f
                                                                    ? (e && c.activeFilter.check("img{width,height}") ? b.setStyle("height", CKEDITOR.tools.cssLength(e)) : b.removeStyle("height"), !d && b.removeAttribute("height"))
                                                                    : 4 == a
                                                                    ? e.match(k)
                                                                        ? b.setStyle("height", CKEDITOR.tools.cssLength(e))
                                            ...
                                            children: [
                                                    ...
                                                    commit: function (a, b, d) {
                                                        ...
                                                        a == f || 4 == a
                                                            ? (isNaN(c)
                                                              ...
                                                              !d && a == f && b.removeAttribute("hspace"))
                                                ...
                                                },
                                                {
                                                    ...
                                                    commit: function (a, b, c) {
                                                        ...
                                                        a == f || 4 == a
                                                            ? (isNaN(e)
                                                                  ? !e && this.isChanged() && (b.removeStyle("margin-top"), b.removeStyle("margin-bottom"))
                                                                  : (b.setStyle("margin-top", CKEDITOR.tools.cssLength(e)), b.setStyle("margin-bottom", CKEDITOR.tools.cssLength(e))),
