<div class="teamplate-element element-<?php echo $index ?> template-banner" id="element-<?php echo $index ?>" data-template="tem5">
    <div class="row">
    ...
    <input type="hidden" value="tem5" name='page_element[<?php echo $index ?>][type_tem]'>
    ...
    <div class="tem-funtion">
        <div class="tem-funtion-wrap">
            ...
            <img class="add-element" src=" <?php echo $url_image ?>add_element.svg" alt="" data-template="tem5" title="add">
        </div>
    </div>
</div>